...
const NavBar = () => {
    ...
    return (
        <div className='w-screen h-[80px] z-10 bg-silver-100 fixed drop-shadow-lg'>
            ...
            <ul ref={navRef} className='absolute md:hidden hidden bg-silver-100 w-full px-8 '>
                ...
                <div className='flex flex-col my-4'>
                    <button className='bg-transparent text-green border-green mb-4 px-7 py-3'>Sign In</button>
